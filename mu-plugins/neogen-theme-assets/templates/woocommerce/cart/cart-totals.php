<?php
/**
 * NeoGen override for cart totals (the right-rail summary on /cart/).
 *
...
<div class="cart_totals ng-cart-totals <?php echo (WC()->customer->has_calculated_shipping()) ? 'calculated_shipping' : ''; ?>">

  <?php do_action('woocommerce_before_cart_totals'); ?>

  <div class="ng-cart-totals-head">
    <span>// ORDER LEDGER</span>
    <span><?php esc_html_e('Cart totals', 'woocommerce'); ?></span>
  </div>

  <table cellspacing="0" class="shop_table shop_table_responsive ng-cart-totals-table">
  ...
  <div class="ng-cart-vat-note">VAT <b>15%</b> INCLUDED · SHIPPING 2-5D KSA METROS</div>

  <div class="wc-proceed-to-checkout ng-cart-checkout">
