...
<footer class="ng-footer">
  ...
  <div class="ng-foot-bottom">
    ...
    <a href="https://tiktok.com/@neogen.store" target="_blank" rel="noopener noreferrer"
       class="ng-foot-tiktok" aria-label="TikTok @neogen.store"
       style="display:inline-flex;align-items:center;gap:6px;color:inherit;text-decoration:none;opacity:.55;transition:opacity .15s;"
